-- Fix ambiguous card_id reference in get_due_flashcards
...
BEGIN
  ...
  LEFT JOIN LATERAL (
    ...
    WHERE cr.card_id = cv.card_id  -- Fully qualified: cr.card_id references card_reviews.card_id
      AND cr.card_index = cv.card_index
