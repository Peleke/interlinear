...
import { ArrowLeft, CheckCircle, Loader2, ChevronDown, ChevronUp, Eye, Play } from 'lucide-react'
...
export default function LessonViewer({
  ...
  useEffect(() => {
    const initCourseDeck = async () => {
      ...
      console.log('[LessonViewer] Getting course deck for courseId:', courseId, 'title:', lesson.courses?.title)
      ...
      if (deck) {
        ...
        console.error('[LessonViewer] Failed to get course deck!')
      }
    }
        ...
        {showPracticeMode && (
          <PracticeSession
            ...
            onComplete={(xpEarned) => {
              ...
              toast.success(`🎉 Practice completed! You earned ${xpEarned} XP!`, {
                description: 'Great job! Keep up the excellent work.',
                duration: 3000
              })
            }}
